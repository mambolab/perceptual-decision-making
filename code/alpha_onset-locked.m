...
% in the easy and hard coherence levels locked to stimulus onset (Figure 4A).
% 
...
for k = 1:n_subjects
    ...
    % Easy condition
    tfa_easy = data.tfa.powspctrm_easy_ol(:, :, indx_all);
    ...
    % Hard condition
    tfa_hard = data.tfa.powspctrm_hard_ol(:, :, indx_all);
