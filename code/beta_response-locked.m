% This function calculates the time evolution of the beta power modulation 
% in the easy and hard coherence levels locked to response onset (Figure 5B).
% 
...
data_path = '/home/robbis/git/perceptual-decision-making/data/'
n_subjects = 16;
band = 'beta';


%% BETA power response-locked
...
for k = 1:n_subjects
    ...
    data = load(fullfile(data_path, band, fname));
